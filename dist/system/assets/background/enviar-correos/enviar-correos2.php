...
// $conexion = new mysqli($s, $u, $p,$db );
    ...
    $from_name = 'Rafa desde Academia Mexicana de Energía';

    //attachment files path array
    $files = array('CIE.pdf','IEC.pdf');
    $subject = 'Último día para envío de resúmenes';
    $html_content = '
    ...
    <body style="margin: 0; padding: 0;">
     ...
     <tr>
       ...
       <td align="center" bgcolor="#fff" style="padding: 0px 0 0px 0;">
        ...
        <img src="https://amexen.org/iec/2019/enviar-correos/giphy.gif" alt="" width="500"  style="display: block;" />
      </a>
       </td>
     ...
     <tr>
       ...
       <tr>
        ...
        Listo para la pedota?
        <br>
        <br>
        <font color= "#4CAF50">¡No te quedes con las ganas de participar!</font>
        <br><br>
       ...
       <tr>
        ...
        <td>
          ...
          <a href="https://amexen.org/iec/2019/envio-resumenes">
            <img src="https://amexen.org/iec/2019/enviar-correos/btn-subir-resumen.png" width="150px" alt="" />
         </a>
